...
function App() {
  return (
    ...
    <div className="container flex mx-auto p-5 items-center flex-col">
      <img className='pt-15' src="/public/Bloxlaunch-Logo.svg" alt="Bloxlaunch Logo" />
      ...
      <img className='w-[900px] pt-8' src="/public/showcase.png" alt="" />
      ...
      <Feature title="Game Information" description="See the games icons and banners" icon={IoImage}/>
